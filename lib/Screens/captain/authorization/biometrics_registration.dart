...
class BiometricsRegister extends StatefulWidget {
  const BiometricsRegister({Key? key}) : super(key: key);

  @override
  State<BiometricsRegister> createState() => _BiometricsRegisterState();
}

class _BiometricsRegisterState extends State<BiometricsRegister> {
