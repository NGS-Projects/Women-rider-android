...
// class UserUploadDocs extends StatefulWidget {
//   const UserUploadDocs({super.key});

//   @override
//   State<UserUploadDocs> createState() => _UserUploadDocsState();
// }
...
class UserUploadDocs extends StatefulWidget {
  const UserUploadDocs({Key? key}) : super(key: key);

  @override
  State<UserUploadDocs> createState() => _UserUploadDocsState();
}

class _UserUploadDocsState extends State<UserUploadDocs> {
...
// Assuming _capturedImagePath is not null, you can create a File object like this:
          ...
          apicontroller.userUploadDocs(imageFile!);
          //    apicontroller.captainAvailability(imageFile!);
